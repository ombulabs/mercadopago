module MercadoPago
  ...
  module Collection
    ...
    #
    # Receives an access_token and a search hash, and returns matching payments, according to the search hash.
    #
    # - access_token [String] : an access_token of the MercadoPago account associated with the payment to be checked.
    # - search_hash [Hash] : querystring in hash format in order to search for a collection.
    #
    ...
    # currency_id::
    #   Currency type. Argentina: ARS (peso argentino) ó USD (Dólar estadounidense); Brasil: BRL (Real).
    # external_reference::
