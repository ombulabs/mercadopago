module MercadoPago
  ...
  module Collection
    ...
    #
    # Receives `access_token` and `search_hash` hashes, and returns matching payments, according to the `search` params.
    #
    # @param [Hash] search_hash querystring in hash format.
